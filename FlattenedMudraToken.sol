...
//      */
//     constructor(string memory tokenName, string memory tokenSymbol, address _owner)
...
//         isWhitelister[_owner] = true;
//         isBlacklister[_owner] = true;

//         // Whitelist the owner by default
//         isWhitelisted[_owner] = true;

//         emit WhitelisterStatusUpdated(_owner, true);
//         emit BlacklisterStatusUpdated(_owner, true);
//         emit AddressWhitelisted(_owner, true);
//     }
